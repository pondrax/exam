...
<div class="flex md:justify-between">
	<div>
		<h2 class="align-middle text-2xl">Berita</h2>
	</div>
	<div class="join">
...
<div class="bg-base-100 flex flex-grow flex-col overflow-x-auto rounded-xl">
	<table class="table">
		<!-- head -->
		<thead>
			<tr>
	...
	<div class="mt-auto flex justify-center p-2">
		<button class="btn btn-primary btn-sm">Muat Selanjutnya</button>
	</div>
</div>
